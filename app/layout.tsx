...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    images: [{ url: "/assets/seoul-hangang.jpeg", width: 1200, height: 1800, alt: "석양의 한강과 남산서울타워가 보이는 서울 전경" }],
  },
  twitter: { card: "summary_large_image", title: "RetailPulse Korea · Seoul", description: "서울의 외국인 쇼핑수요 신호를 오늘과 내일 관점에서 읽습니다.", images: ["/assets/seoul-hangang.jpeg"] },
};
