...
const copy = {
  ko: {
    ...
    uses: [
      ["공항·면세점 근무자", "공항에서 터미널을 고른 뒤 출국장 예상 승객, 피크 시간, 출발편과 출국장 대기를 함께 확인해 근무와 휴게 시간을 준비하세요."],
    ...
    method: "기관이 발표한 자료를 지역·날짜·터미널별로 정리합니다. 현재 관측, 앞으로의 공식 예상, 이미 지난 실적은 서로 다른 값입니다. 출국장 예상 승객은 실제 대기인원이 아니며, 내국인 카드 소비는 외국인 소비나 전체 매출이 아닙니다. 비교 수치는 같은 대상·기간의 자료가 있을 때만 계산합니다.",
