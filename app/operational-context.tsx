...
export function SeoulContextCard({context,lang}:{context?:SeoulContext & {retrievedAt?:string}|null;lang:Lang}) {
  ...
  return <div className="operational-context">
    {!!context.categories.length && <div>
      ...
      <small>{t('서울시·신한카드 내국인 소비 · 관측 시각 기준 10분','Seoul/Shinhan domestic-card activity · 10-minute observation window','首尔市·新韩卡韩国居民消费 · 最近10分钟','ソウル市・新韓カード国内消費 · 直近10分')} · {context.commercialAt?.slice(5,16).replace('T',' ')} KST</small>
