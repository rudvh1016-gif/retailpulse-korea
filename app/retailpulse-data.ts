...
export const sourceCatalog = [
  { source: "INCHEON AIRPORT FORECAST", provider: "Incheon Airport", use: { ko: "D+1 도착 기준 환승 보안검색 예고", en: "D+1 arrival-based transfer security forecast", zh: "D+1按到达日的中转安检预报" }, status: "OFFICIAL_FORECAST", realtime: "Official daily Excel", history: "Stored by service date from activation", coverage: "D+1 arrival transfer security; no combined departures", lag: "Daily 17:00", geo: "T1 / T2 separately", key: "No key required", free: "Public viewing / Excel", commercial: "Automation terms not verified", redistribution: "Derived summaries after review", priority: "P0", tier: "conditional" },
