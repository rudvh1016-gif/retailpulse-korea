...
const text = {
  ...
  intro: {
    ko: "공식 데이터로 확인된 신호만 표시합니다. 신호는 매출이나 방문자 수가 아닙니다.",
    en: "Only signals backed by official data appear here. A signal is not sales or visitor counts.",
    zh: "仅显示经官方数据确认的信号。信号不等于销售额或访客数。",
    ja: "公式データで確認できたシグナルのみ表示します。シグナルは売上や来訪者数ではありません。",
  },
