...
- **T1 arrival fields**: `t1eg1` (arrival hall A/B), `t1eg2` (E/F), `t1eg3` (C), `t1eg4` (D), `t1egsum1` (official T1 arrival total). The Seoul and Tourism views use only the official aggregate arrival rows as area-independent background context; they never call them observed arrivals, Seoul visitors, or a leading signal for demand in a specific area, and the departure-facing Airport view remains separate.
