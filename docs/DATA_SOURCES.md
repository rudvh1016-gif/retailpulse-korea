...
creates a second flight or credits the marketing partner. The provider's own
airline name (A1 `airline`, stored in `airport_flights.airline_code`) is the
primary label. Nothing in the ranking is estimated.
